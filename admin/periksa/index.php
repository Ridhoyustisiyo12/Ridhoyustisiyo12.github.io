                                    ...
                                    <div class="table-responsive custom-table-responsive">
                                        <table class="table custom-table">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                $sql = "SELECT periksa.*, pasien.nama as pasien, paramedik.nama as dokter FROM periksa INNER JOIN pasien ON periksa.pasien_id = pasien.id INNER JOIN paramedik ON periksa.paramedik_id = paramedik.id";
